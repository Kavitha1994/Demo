					...
					<c:if test="${editMode}">
						<div class="form-group">
							<form:input type="text" class="form-control"
								id="inputCategoryName" placeholder=""
							...
							<c:forEach items="${catlist}" var="c">
								<tr>
									...
									<td class="td-actions text-right">
										<a href="editCategory?categoryName=${c.categoryName}" rel="tooltip"  class="btn btn-success btn-link btn-just-icon btn-sm" data-original-title="" title="">
											<i class="material-icons">edit</i>
										</a>
										<a href="deletecategory?categoryName=${c.categoryName}" rel="tooltip" class="btn btn-danger btn-link btn-just-icon btn-sm"
